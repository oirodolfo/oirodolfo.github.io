...
!(function (e, t) {
  ...
  return (function (e) {
            ...
            ((c = !d && b && void 0 !== b[s]) && i(g, s)) ||
              ...
              (g[s] =
                p && "function" != typeof b[s]
                  ...
                  ? a(Function.call, f)
                  : f),
              m && (((g.virtual || (g.virtual = {}))[s] = f), e & l.R && _ && !_[s] && u(_, s, f)));
        };
      (l.F = 1),
        (l.G = 2),
        (l.S = 4),
    ...
    function (e, t, n) {
      ...
      function r(e, t) {
        ...
        n &&
          ...
          (l = n.end.column),
          (e += " - " + a + ":" + i));
        for (var s = Error.prototype.constructor.call(this, e), c = 0; c < o.length; c++)
          this[o[c]] = s[o[c]];
    ...
    function (e, t, n) {
      ...
      t.default =
        "function" == typeof i.default && "symbol" === l(a.default)
          ? function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, h, m, v, y) {
        ...
        if (
          (j &&
            (b = c(j.call(new e()))) !== Object.prototype &&
            b.next &&
            (s(b, w, !0), r || "function" == typeof b[f] || u(b, f, p)),
          O &&
            S &&
            "values" !== S.name &&
            ((M = !0),
          ...
          if (((g = { values: O ? k : x("values"), keys: v ? k : x("keys"), entries: P }), y))
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        function t(e) {
          ...
          return (
            c(e.attributes, function (t) {
              var o = t.name,
                a = t.value;
              n.push({ name: o, value: a, underline: r(e, o) });
            }),
            (t.attributes = n),
            t
          );
        ...
        function r(e, t) {
          var n = e.tagName;
          return (
            (("SCRIPT" === n || "IMAGE" === n || "VIDEO" === n || "AUDIO" === n) && "src" === t) ||
            ("LINK" === n && "href" === t)
          );
        }
        function o(e) {
        ...
        return new ((function (e) {
          function r() {
            ...
            return (
              ...
              (e._isInit = !1),
              (e._htmlTagTpl = n(103)),
              (e._textNodeTpl = n(118)),
              (e._selectedEl = document.documentElement),
              (e._htmlCommentTpl = n(119)),
              (e._elementChangeHandler = function (t) {
            ...
            (0, f.default)(r, [
              {
                ...
                value: function (e, t) {
                  (0, m.default)(
                    ...
                    (this._container = t),
                    e.html(n(120)()),
                    (this._$domTree = e.find(".eruda-dom-tree")),
                    this._bindEvent();
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = [];
                  for (t.push(e); e.parentElement; )
                    t.unshift(e.parentElement), (e = e.parentElement);
                  for (; t.length > 0; ) {
                    e = t.shift();
                    var n = e.erudaDom;
                    if (!n) break;
                    n.close && n.open && (n.close(), n.open()),
                      0 === t.length && e.erudaDom && e.erudaDom.select();
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = this._container,
                    n = t.get("elements");
                  n && n.on("change", this._elementChangeHandler),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  var o = t.get(0);
                  e && r.push({ nodeType: "END_TAG", node: e }),
                    c(r, function (e) {
                ...
                value: function (e, n) {
                  ...
                  if ((u.addClass("eruda-tree-item"), e.nodeType === e.ELEMENT_NODE)) {
                    var l = e.childNodes.length,
                      s = l > 0,
                      c = (0, a.default)({}, t(e), { hasTail: s }),
                      f = 1 === l && e.childNodes[0].nodeType === e.TEXT_NODE;
                    f && (c.text = e.childNodes[0].nodeValue),
                      u.html(this._htmlTagTpl(c)),
                      s && !f && u.addClass("eruda-expandable");
                  } else if (e.nodeType === e.TEXT_NODE) {
                    var d = e.nodeValue;
                    if ("" === d.trim()) return;
                    u.html(this._textNodeTpl({ value: d }));
                  } else if (e.nodeType === e.COMMENT_NODE) {
                    var p = e.nodeValue;
                    if ("" === p.trim()) return;
                    u.html(this._htmlCommentTpl({ value: p }));
                  } else {
                    if ("END_TAG" !== e.nodeType) return;
                    (i = !0),
                      (e = e.node),
                      u.html(
                        '<span class="eruda-html-tag" style="margin-left: -12px;">&lt;<span class="eruda-tag-name">/' +
                          e.tagName.toLocaleLowerCase() +
                          '</span>&gt;</span><span class="eruda-selection"></span>',
                      );
                  }
                  var h = o("ul");
                  if (
                    (h.addClass("eruda-children"),
                    n.appendChild(u.get(0)),
                    n.appendChild(h.get(0)),
                    e.nodeType === e.ELEMENT_NODE)
                  ) {
                    var m = {};
                    if (u.hasClass("eruda-expandable")) {
                      var v = function () {
                          u.html(r._htmlTagTpl((0, a.default)({}, t(e), { hasTail: !1 }))),
                            u.addClass("eruda-expanded"),
                            r._renderChildren(e, h);
                        },
                        y = function () {
                          h.html(""),
                            u.html(r._htmlTagTpl((0, a.default)({}, t(e), { hasTail: !0 }))),
                    ...
                    var _ = function () {
                      r._$el.find(".eruda-selected").rmClass("eruda-selected"),
                        u.addClass("eruda-selected"),
                        (r._selectedEl = e),
                        r._setElement(e);
                    };
    ...
    function (e, t, n) {
      e.exports = { default: n(53), __esModule: !0 };
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var r = n(2),
        ...
        K = function (e, t, n) {
          return (
            ...
            o(V, t)
              ? (n.enumerable
                  ? (o(e, A) && e[A][t] && (e[A][t] = !1), (n = M(n, { enumerable: O(0, !1) })))
                  : (o(e, A) || C(e, A, O(1, {})), (e[A][t] = !0)),
                W(e, t, n))
              : C(e, t, n)
          );
        },
        ...
        ee = function (e) {
          for (var t, n = N(x(e)), r = [], a = 0; n.length > a; )
            o(V, (t = n[a++])) || t == A || t == l || r.push(t);
          return r;
        },
        te = function (e) {
          for (var t, n = e === B, r = N(n ? G : x(e)), a = [], u = 0; r.length > u; )
            !o(V, (t = r[u++])) || (n && !o(B, t)) || a.push(V[t]);
          return a;
        };
      z ||
        ((L = function () {
          ...
          return a && q && W(B, e, { configurable: !0, set: t }), $(e);
        }),
        ...
        (n(18).f = Q),
        (k.f = te),
        a && !n(16) && i(B, "propertyIsEnumerable", Q, !0),
        (h.f = function (e) {
          return $(p(e));
        })),
      ...
      u(u.S + u.F * ue, "Object", {
        ...
        L.prototype[H] || n(9)(L.prototype, H, L.prototype.valueOf),
        f(L, "Symbol"),
        f(Math, "Math", !0),
        f(r.JSON, "JSON", !0);
    },
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = r(e),
          n = o.f;
        if (n)
          for (var u, i = n(e), l = a.f, s = 0; i.length > s; )
      ...
      e.exports = {
        set:
          ...
          ("__proto__" in {}
            ? (function (e, t, r) {
                try {
                  (r = n(34)(Function.call, n(33).f(Object.prototype, "__proto__").set, 2)),
                    r(e, []),
      ...
      e.exports = (r.default || r).template({
        1: function (e, t, n, r, o) {
          ...
          return (
            ...
            e.escapeExpression(
              ((u = null != (u = n.name || (null != t ? t.name : t)) ? u : e.hooks.helperMissing),
              "function" == typeof u
                ? u.call(i, {
                    name: "name",
                    hash: {},
                    data: o,
                    loc: { start: { line: 7, column: 41 }, end: { line: 7, column: 49 } },
                  })
                : u),
            ) +
            "</span>" +
            (null !=
            (a = n.if.call(i, null != t ? t.value : t, {
              name: "if",
              hash: {},
              fn: e.program(2, o, 0),
              inverse: e.noop,
              data: o,
              loc: { start: { line: 7, column: 56 }, end: { line: 7, column: 181 } },
            }))
              ? a
              : "") +
            "</span>"
        ...
        2: function (e, t, n, r, o) {
          var a,
            ...
            i = null != t ? t : e.nullContext || {};
          return (
            '="<span class="eruda-attribute-value' +
            (null !=
            (a = n.if.call(i, null != t ? t.underline : t, {
              name: "if",
              hash: {},
              fn: e.program(3, o, 0),
              inverse: e.noop,
              data: o,
              loc: { start: { line: 7, column: 105 }, end: { line: 7, column: 155 } },
            }))
              ? a
              : "") +
            '">' +
            e.escapeExpression(
              ((u = null != (u = n.value || (null != t ? t.value : t)) ? u : e.hooks.helperMissing),
              "function" == typeof u
                ? u.call(i, {
                    name: "value",
                    hash: {},
                    data: o,
                    loc: { start: { line: 7, column: 157 }, end: { line: 7, column: 166 } },
                  })
                : u),
            ) +
            '</span>"'
        ...
        5: function (e, t, n, r, o) {
          ...
          return (
            (null !=
            (a = n.if.call(i, null != t ? t.text : t, {
              name: "if",
              hash: {},
              fn: e.program(6, o, 0),
              inverse: e.program(8, o, 0),
              data: o,
              loc: { start: { line: 13, column: 2 }, end: { line: 13, column: 38 } },
            }))
              ? a
              : "") +
            ...
            e.escapeExpression(
              ((u =
                null != (u = n.tagName || (null != t ? t.tagName : t)) ? u : e.hooks.helperMissing),
              "function" == typeof u
                ? u.call(i, {
                    name: "tagName",
                    hash: {},
                    data: o,
                    loc: { start: { line: 16, column: 34 }, end: { line: 16, column: 45 } },
                  })
                : u),
            ) +
            "</span>&gt;</span>\n"
        ...
        6: function (e, t, n, r, o) {
          ...
          return e.escapeExpression(
            ((a = null != (a = n.text || (null != t ? t.text : t)) ? a : e.hooks.helperMissing),
            "function" == typeof a
              ? a.call(null != t ? t : e.nullContext || {}, {
                  name: "text",
                  hash: {},
                  data: o,
                  loc: { start: { line: 13, column: 14 }, end: { line: 13, column: 22 } },
                })
              : a),
          );
        },
            ...
            e.escapeExpression(
              ...
              "function" == typeof u
                ? u.call(i, {
                    ...
                    hash: {},
                    data: o,
                    loc: { start: { line: 4, column: 33 }, end: { line: 4, column: 44 } },
                  })
                : u),
            ) +
            "</span>" +
            (null !=
            (a = n.each.call(i, null != t ? t.attributes : t, {
              name: "each",
              hash: {},
              fn: e.program(1, o, 0),
              inverse: e.noop,
              data: o,
              loc: { start: { line: 5, column: 4 }, end: { line: 9, column: 13 } },
            }))
              ? a
              : "") +
            "&gt;</span>" +
            (null !=
            (a = n.if.call(i, null != t ? t.hasTail : t, {
              name: "if",
              hash: {},
              fn: e.program(5, o, 0),
              inverse: e.noop,
              data: o,
              loc: { start: { line: 12, column: 2 }, end: { line: 19, column: 7 } },
            }))
              ? a
              : "") +
      ...
      (t.default = function (e) {
        e.registerHelper("blockHelperMissing", function (t, n) {
          ...
          if (n.data && n.ids) {
            ...
            (u.contextPath = r.appendContextPath(n.data.contextPath, n.name)), (n = { data: u });
          }
          return a(t, n);
        });
      }),
          ...
          e.registerHelper("each", function (e, t) {
            function n(t, n, r) {
              c &&
                ...
                (c.last = !!r),
                f && (c.contextPath = f + t)),
                (s += a(e[t], { data: c, blockParams: o.blockParams([e[t], t], [f + t, null]) }));
            }
    ...
    function (e, t, n) {
      ...
      var r = n(1),
        o = {
          ...
          log: function (e) {
            if (
              ((e = o.lookupLevel(e)), "undefined" != typeof console && o.lookupLevel(o.level) <= e)
            ) {
              var t = o.methodMap[e];
              console[t] || (t = "log");
    ...
    function (e, t, n) {
      ...
      function o(e, t) {
        function n(n, r, o) {
          o.hash && ((r = d.extend({}, r, o.hash)), o.ids && (o.ids[0] = !0)),
            (n = t.VM.resolvePartial.call(this, n, r, o));
          var a = d.extend({}, o, { hooks: this.hooks }),
            u = t.VM.invokePartial.call(this, n, r, a);
          if (
            (null == u &&
              t.compile &&
              ((o.partials[o.name] = t.compile(n, e.compilerOptions, t)),
              (u = o.partials[o.name](r, a))),
            null != u)
          ) {
            if (o.indent) {
              for (var i = u.split("\n"), l = 0, s = i.length; l < s && (i[l] || l + 1 !== s); l++)
                i[l] = o.indent + i[l];
              u = i.join("\n");
            }
            return u;
        ...
        function r(t) {
          ...
          return (
            e.useDepths &&
              (i = o.depths ? (t != o.depths[0] ? [t].concat(o.depths) : o.depths) : [t]),
            (n = c(e.main, n, u, o.depths || [], a, l))(t, o)
          );
        }
        ...
        var o = e.compiler && 7 === e.compiler[0],
          u = {
            ...
            program: function (e, t, n, r, o) {
              ...
              return (
                t || o || r || n
                  ? (u = a(this, e, i, t, n, r, o))
                  : u || (u = this.programs[e] = a(this, e, i)),
                u
              );
            },
            data: function (e, t) {
        ...
        return (
          ...
          (r._setup = function (n) {
            if (n.partial)
              ...
              (u.helpers = d.extend({}, t.helpers, n.helpers)),
                e.usePartial && (u.partials = d.extend({}, t.partials, n.partials)),
                (e.usePartial || e.useDecorators) &&
                  (u.decorators = d.extend({}, t.decorators, n.decorators)),
                (u.hooks = {});
              var r = n.allowCallsToHelperMissing || o;
              v.moveHelperToHooks(u, "helperMissing", r),
                v.moveHelperToHooks(u, "blockHelperMissing", r);
            }
          }),
      ...
      function a(e, t, n, r, o, a, u) {
        function i(t) {
          var o = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
            i = u;
          return (
            !u || t == u[0] || (t === e.nullContext && null === u[0]) || (i = [t].concat(u)),
            n(e, t, e.helpers, e.partials, o.data || r, a && [o.blockParams].concat(a), i)
          );
        }
        return (
          (i = c(n, i, e, u, r, a)),
          (i.program = t),
          (i.depth = u ? u.length : 0),
          (i.blockParams = o || 0),
          i
        );
      }
    ...
    function (e, t, n) {
      ...
      e.exports = (r.default || r).template({
        ...
        main: function (e, t, n, r, o) {
          var a;
          return (
            '"<span class="eruda-text-node">' +
            e.escapeExpression(
              ((a = null != (a = n.value || (null != t ? t.value : t)) ? a : e.hooks.helperMissing),
              "function" == typeof a
                ? a.call(null != t ? t : e.nullContext || {}, {
                    name: "value",
                    hash: {},
                    data: o,
                    loc: { start: { line: 1, column: 31 }, end: { line: 1, column: 40 } },
                  })
                : a),
            ) +
            '</span>"'
            ...
            e.escapeExpression(
              ...
              "function" == typeof a
                ? a.call(null != t ? t : e.nullContext || {}, {
                    ...
                    hash: {},
                    data: o,
                    loc: { start: { line: 1, column: 41 }, end: { line: 1, column: 50 } },
                  })
                : a),
            ) +
            " --&gt;</span>"
